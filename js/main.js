(function($){
	...
	$project.each(function(index, element){
		...
		tlProject
			...
			.add("imageIn")
			.staggerFromTo($pixel, 0.3, {autoAlpha: 0, x: "-=10"}, {autoAlpha: 1, x: "'0" , ease:Power4.easeInOut}, 0.12, "-=0.2")
			.add("pixelsIn")
			...
			.add("titleOut")
			.to($projectImage, 6, {xPercent: "0", ease:Linear.easeNone, onComplete: pauseProjects, onCompleteParams: [projectClass, tlProjectLoader]}, "imageIn")
			.add("imageOut")
